...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 04, 2023 at 01:00 PM
...
(6, 'bb', 'mouse problem', 'double click not working', '0'),
(7, 'mahbub 2', 'hard disk not working', 'hard disk not found', '0'),
(8, 'Imran dhanmondi', 'electric shock', 'pc is giving me shock', '0');
...
--
ALTER TABLE `comments`
  ADD CONSTRAINT `comments_ibfk_2` FOREIGN KEY (`pid`) REFERENCES `products` (`id`) ON DELETE CASCADE;
