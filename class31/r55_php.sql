...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 05, 2023 at 10:46 AM
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_products` ()   SELECT id,sku ,name, description, price, image FROM products ORDER by name$$

--
-- Functions
--
CREATE DEFINER=`root`@`localhost` FUNCTION `calculate_bonus` (`emp_id` INT(5)) RETURNS DECIMAL(10,2) COMMENT 'Calculate employee SALES bonus' BEGIN
...
(1, 'Electronics', '2023-06-04 04:42:34'),
(2, 'Garments', '2023-06-04 04:43:16'),
(3, 'Automobiles', '2023-06-04 04:43:16');
...
INSERT INTO `comments` (`id`, `pid`, `user_id`, `comment`, `created_at`) VALUES
(3, 1, 2, 'testsdgf sdffg', '2023-06-05 04:22:34'),
(4, 1, 2, 'another comment', '2023-06-05 04:33:15'),
(5, 1, 2, 'some core comment', '2023-06-05 04:33:25'),
(6, 1, 2, 'hr g dsfgdf gf fdg dsfg', '2023-06-05 04:36:36'),
(7, 1, 1, 'message from admin', '2023-06-05 04:39:28');
...
(36, 'rj2349k3', 'Boom', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.', '777.00', '1685767041_91-Db4L6xjL.png', '2023-06-03 04:37:21');
...
(1, 'Mobile', 1, '2023-06-04 04:44:16'),
(2, 'Computer', 1, '2023-06-04 04:44:16');
...
(2, 'Mr kazi vai', 'Printer problem', 'paper feed problem', '3'),
...
(2, 'mamun', 'mamun@gmail.com', '$2y$10$G8K7/7D5mTKCPkFAu4aeXOE4TolVEJih9YffD51lY.2sK4aUVtyAC', 1, 1, '2023-06-03 05:09:30');
