...
<head>
    ...
    <title>Secret Messaging with Key: encrypt message</title>
...
<body>
    ...
    <form action="" method="post">
        ...
        <input class="my-3 btn btn-outline-success" type="submit" value="Encrypt message with your secret key">
    </form>
    <hr>
    <?php 
    if(isset($result)){
        ?>
    <div>
        <h1 class="bg-info">You secret message: </h1>
        <p class="text-primary"><?php echo $result??"";?></p>
    </div>
        <?php
    }
    ?>
