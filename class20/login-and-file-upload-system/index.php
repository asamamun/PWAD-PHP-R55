...
<?php if(!isset($_SESSION['auth'])) header("location:login.php"); ?>
            ...
            <div class="col-md-9 col-sm-12 mx-auto">
                <div class="row">
                    <div class="offset-2 col-md-8">
                        <h5 class="pg-title text-center mt-3"><?= "welcome ".$_SESSION['username'];?> <a class="text-secondary" href="logout.php">logout</a></h5>
